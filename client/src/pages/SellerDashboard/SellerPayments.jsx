                                                    ...
                                                    <tr className="text-sm h-10 border dark:border-slate-600">
                                                        {orders.map((data) => {
                                                            data.items.map((items) => {
                                                                ...
                                                                if (items.sellerEmail === localStorage.getItem('email')) {
                                                                    console.log("After Item Mapping",items)
                                                                    return (
                                                                        <div>
                                                                            <TableData value={data._id} />
                                                                            <TableData value={items.itemID} />
                                                                            <TableData value={items.price} />
                                                                            <TableData value={items.quantity} />
                                                                            <TableData value={data.status} />
                                                                            <TableData value={items.price * .15} />
